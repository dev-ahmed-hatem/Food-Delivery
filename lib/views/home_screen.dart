import 'package:basic_app/iti_project/lists/Menu_list.dart';
import 'package:basic_app/iti_project/lists/Res_list.dart';
import 'package:basic_app/iti_project/models/Res_model.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    image: DecorationImage(
        image: AssetImage("assets/Device_images/background.png"),
        fit: BoxFit.cover
    )
    ),
          child: Padding(
                  ...
                  child: Column(
                   crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    children: [
                      ...
                      children: [
                        Text("Find Your\nFavourite Food",  textAlign: TextAlign.left,
                         ...
                         Padding(
                           ...
                           child: Container(
                             ...
                             width: 50,
                                ...
                                child:
                                Container(
                                  child: Icon(CupertinoIcons.bell, color: notification,
                                  ),
                                )
                            ),
                         ),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image:DecorationImage(
                                  image: AssetImage(
                                      "assets/Device_images/Promo.png"
                                  ),
                                  fit: BoxFit.fill
                                  ,
                                ) ),
                      ...
                      Row(
                        children: [
                          Text("Food Items Menu",  textAlign: TextAlign.left,
                            style: const TextStyle(
                                fontWeight: FontWeight.w900,
                                fontSize: 20,
                                color: textColor,
                      ...
                      Row(
                          children: [
                            Text("Popular Menu",  textAlign: TextAlign.left,
                              style: const TextStyle(
                                  fontWeight: FontWeight.w900,
                                  fontSize: 20,
                                  color: textColor,
